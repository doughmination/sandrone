...
class Decrypt(commands.Cog):
    ...
    @app_commands.choices(method=[
        app_commands.Choice(name=name, value=value) for name, value in decoderSystem.items()
    ])
    async def decryptSlash(self, interaction: discord.Interaction, input: str, method: app_commands.Choice[str] = None) -> None:
