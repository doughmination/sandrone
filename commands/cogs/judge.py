...
class Judge(commands.Cog):
    ...
    @app_commands.command(name="judge", description="Get Sandrone's Judgement on a user")
    @app_commands.describe(user="The user to judge")
    @mood.sassy
    async def judgeSlash(self, interaction: discord.Interaction, user: discord.User | None = None) -> None:
