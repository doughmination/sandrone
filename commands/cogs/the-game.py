...
class TheGame(commands.Cog):
    ...
    @app_commands.command(name="explain-the-game", description="You just lost the game haha!")
    ...
    async def buildTheGameRules(self) -> discord.Embed:
        embed = discord.Embed(color=discord.Color.fuchsia(), title="Rules of The Game", description=" ")
        embed.description += "**Rule 1:**\nThe Game is 'The Game'."
        ...
        embed.description += "\n\n**Rule 7:**\n(a) There is only one way to win The Game, and that is to truly and honestly forget about it completely. (b) This also means that if you do manage to win The Game, you will never know that you have won. This is because if you know you have won, then you have just thought about it (and consequently lost)."
        embed.description += "\n\n**Rule 8:** If you lose The Game, and someone (foolishly) asks \"whats The Game?\", please either explain it to them, or direct them toward this command, as an unspoken purpose to The Game is to get as many people playing as possible"
        return embed
