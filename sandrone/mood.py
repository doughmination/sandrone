...
sassy_replies = [
    ...
    (
        "Your command has been rejected on the grounds that Sandrone "
...
judge_certain_user = {
    ...
    1542295080524845148: (
        "The puppet decided that the real Sandrone is much nicer."
    ),
}
...
judge_replies = [
    ...
    (
        "The puppet has observed this individual. Further investigation "
        "is recommended."
    ),
    "Verdict: suspicious.",
    ...
    (
        "The puppet has reviewed the subject and would like to keep them "
        "at a safe distance."
    ),
    ...
    (
        "Sandrone has found insufficient evidence to justify throwing "
    ...
    (
        "Sandrone has determined that this individual has potential. "
        "Whether that is good or bad remains unclear."
    ),
    "The puppet has seen enough. Judgment rendered.",
    "Verdict: guilty of something. Sandrone will determine what later.",
    (
        "Sandrone has decided to give them the benefit of the doubt. She "
        "already regrets it."
    ),
    (
        "The puppet has reviewed their behaviour and would like to speak "
        "to their manager."
    ),
    "Verdict: questionable.",
    "Sandrone sees no reason to panic. Yet.",
    (
        "The puppet has classified this person as 'interesting.' This is "
        "not necessarily a compliment."
    ),
    "Verdict: acceptable specimen.",
    "Sandrone has determined that they may continue existing.",
    (
        "The puppet has reviewed the subject and recommends keeping all "
        "valuable tools locked away."
    ),
    "Verdict: too powerful. Keep an eye on them.",
    (
        "Sandrone has decided that this person is allowed within five "
        "metres of the workshop."
    ),
    "The puppet has reached a conclusion. Nobody asked what it was.",
    "Verdict: Sandrone will tolerate them.",
    (
        "Sandrone has determined that this person is either a genius or a "
        "complete idiot."
    ),
    ...
    (
        "Sandrone has determined that this individual is harmless. The "
        "puppet disagrees."
    ),
    (
        "The puppet has awarded them one point. Nobody knows what the "
        "points are for."
    ),
...
incident_replies = [
    ...
    (
        "Something in the workshop is ticking. Sandrone did not build "
        "anything that ticks."
    ),
    (
        "The puppet has been standing in the corner for six hours. This "
        "is fine."
    ),
    ...
    (
        "A drawer that was locked is now open. Sandrone is choosing not "
        "to investigate."
    ),
    "The puppet has assembled something. It has too many legs.",
    (
        "Sandrone left the room for one minute. The furniture has been "
        "rearranged."
    ),
    "The puppet is watching the ceiling. The ceiling has not moved. Yet.",
    (
        "Sandrone has found a screw on the floor. She does not know what "
        "it came from. This is concerning."
    ),
    (
        "The puppet has started collecting spoons. Nobody has questioned "
        "this out loud."
    ),
    (
        "There is a second puppet now. Sandrone is aware. It is being "
        "handled."
    ),
    "The puppet has climbed onto the workbench and will not come down.",
    (
        "Sandrone's blueprints have been reorganised by colour. She did "
        "not do this."
    ),
    "The puppet has been humming the same three notes since this morning.",
    (
        "A tool is missing. The puppet is making direct eye contact. "
        "Sandrone has drawn her own conclusions."
    ),
]
